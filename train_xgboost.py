...
# Grille de recherche optimisée pour XGBoost
PARAM_GRID = {
...
# ==============================================================================
print("\nCréation et optimisation du modèle XGBoost via GroupKFold...")
print("Régularisation avancée en cours (cela peut prendre un moment)...")

# Le Validateur Étanché
gkf = GroupKFold(n_splits=K_FOLDS)

# XGBoost requiert des classes numérotées de 0 à N-1 (ce que notre data_loader fait déjà)
...
print(f"\nMeilleurs hyperparamètres XGBoost : {grid_search.best_params_}")
...
y_pred_raw = best_xgb_model.predict(X_test)
