...
# Grille de recherche pour le Gradient Boosting (Version Rapide par Histogrammes)
PARAM_GRID = {
    'learning_rate': [0.05, 0.1],         # Vitesse de convergence
    'max_iter': [100, 200],               # Nombre total d'arbres construits
    'max_depth': [3, 5, None]             # Profondeur des arbres (None = expansion libre)
}
...
# ==============================================================================
print("\nCréation et optimisation du Gradient Boosting via GroupKFold...")
print("L'algorithme corrige mathématiquement ses résidus à chaque arbre...")
...
print(f"\nMeilleurs hyperparamètres Gradient Boosting : {grid_search.best_params_}")
...
y_pred_raw = best_gb_model.predict(X_test)
